...
- `qwen3-6-35b-a3b-fp8` — Red Hat AI Qwen3.6-35B-A3B FP8 dynamic (gated-delta-net MoE, 3B active) on vLLM GPU (1 L40S-class GPU, 60Gi RAM, 262k context — native default, no max-model-len override)
